...
## 📐 Support en bois & Gravure Laser

Pour rendre le système parfaitement utilisable au quotidien, le bouton est encastré dans une plaque en bois gravée au laser indiquant clairement les actions.
...
actions:
  ...
  - action: vacuum.return_to_base
    target:
      entity_id: vacuum.roborock_qv_35a# 🤖 Rendre un aspirateur Roborock accessible aux Seniors avec un bouton Zigbee
